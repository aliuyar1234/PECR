...
PECR_CONTROLLER_ENGINE_OVERRIDE="${PECR_CONTROLLER_ENGINE_OVERRIDE:-baseline}"
...
PECR_RATE_LIMIT_WINDOW_SECS="${PECR_RATE_LIMIT_WINDOW_SECS:-60}"
PECR_RATE_LIMIT_RUN_PER_WINDOW="${PECR_RATE_LIMIT_RUN_PER_WINDOW:-500000}"
PECR_RATE_LIMIT_SESSIONS_PER_WINDOW="${PECR_RATE_LIMIT_SESSIONS_PER_WINDOW:-500000}"
PECR_RATE_LIMIT_OPERATORS_PER_WINDOW="${PECR_RATE_LIMIT_OPERATORS_PER_WINDOW:-2000000}"
PECR_RATE_LIMIT_FINALIZE_PER_WINDOW="${PECR_RATE_LIMIT_FINALIZE_PER_WINDOW:-500000}"
...
export PECR_RATE_LIMIT_WINDOW_SECS
export PECR_RATE_LIMIT_RUN_PER_WINDOW
export PECR_RATE_LIMIT_SESSIONS_PER_WINDOW
export PECR_RATE_LIMIT_OPERATORS_PER_WINDOW
export PECR_RATE_LIMIT_FINALIZE_PER_WINDOW
...
echo "[suite7] rate limits window=${PECR_RATE_LIMIT_WINDOW_SECS}s run=${PECR_RATE_LIMIT_RUN_PER_WINDOW} sessions=${PECR_RATE_LIMIT_SESSIONS_PER_WINDOW} operators=${PECR_RATE_LIMIT_OPERATORS_PER_WINDOW} finalize=${PECR_RATE_LIMIT_FINALIZE_PER_WINDOW}"
